...
Contributors: aveek, arimghosh, Dualcube
Donate link: http://www.dualcube.com
Tags: wordpress, woocommerce, e-commerce, shop, review, rating, sorting reviews, grouping reviews, woocommerce reviews, e-commerce reviews, sort reviews by ratings, sort reviews by date
...
All new WordPress WooCommerce plugin by which a customer can group all reviews by rating or date.
...
*   Creates a dropdown menu – Sort by Rating – on the Review tab of single product pages to let buyers choose an option ( 5 stars, 4 stars...or any other term you use to separate these ) and group reviews accordingly.
*   Creates a dropdown menu – Sort by Date – on the Review tab of single product pages to let buyers choose an option ( Newest or Oldest ) and group reviews accordingly.
*   This is an extremely light-weight plugin; it doesn't hamper the speed of your website and ensures smooth transition and reviews sorting.
...
= Feedback =
Thanks heaps for trying this plugin. I hope it could serve your purpose. If you find this plugin is helpful, appreciate us by giving a 5/5 star and feel free to comment as well as suggest additional features. If you find the plugin is buggy, please do mention on support forum and we will fix bugs ASAP. For more information and instructions on this plugin please visit www.dualcube.com. 

== Installation ==
1.  Upload the `WooCommerce Product Review Sorting` folder to the `/wp-content/plugins` directory.
2.  Activate the plugin through the `Plugins` menu in WordPress.
3.  Turn on the plugin's activity through `WC Review Sort` in WooCommerce sub-menu.
4.  All done. Just check on product review tab and group reviews according to its rating and date.
...
Yes, this plugin is compatible with WooCommerce 2.1 or later.

= Does this plugin work with all types of theme =
Yes, this plugin is compatible with all latest version of WooCommerce themes.

== Screenshots ==
1. WC Review Sort Settings panel.
2. Product review sorting dropdown.
3. Some reviews with 4 star is selected.
4. Some reviews with Newest is selected.
5. Some reviews with 5 star and Newest is selected.

== Changelog ==
= 1.0.6 =
*   Now customer can sort reviews by date.
*   Admin can customize all label shown in the dropdowns.

= 1.0.5 =
*   Compatible with WooCommerce 2.3.9 and fixed some bugs

= 1.0.4 =
*   Compatible with WordPress version 4.2.2

= 1.0.3 =
*   Compatible with WordPress version 4.2.1
